...
const Contact = () => {
  ...
  return (
    <div id="contact" className="px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 2xl:px-[20rem] py-[100px]">
        <div className="flex flex-col gap-6 md:gap-10">
            ...
            <div className="flex flex-col gap-6 sm:flex-row justify-between items-center sm:items-baseline w-full">
                <div className="flex items-center gap-2">
                    <input type="checkbox" className="accent-[#00b2d1] h-6 w-6 cursor-pointer rounded-xl" name="" id="" onChange={()=>setAccepted(!accepted)}/>
                    <p className="text-base font-normal text-gray-300 max-w-3xl mt-3">By submitting this form and making your data available, you expressly consent to its treatment to manage future contacts and responding to requests sent. </p>
                </div>
                    {success && (
