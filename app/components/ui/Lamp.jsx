...
const Lamp = ({
  ...
  return (
    <div
      className={cn(
        "relative flex min-h-screen flex-col items-center justify-center bg-neutral-900 w-full rounded-md z-0 px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 2xl:px-[20rem]",
        className
      )}
    >
      ...
      <div className="relative z-50 flex md:-translate-y-[15rem] flex-col gap-6 items-center px-5">
        {children}
      </div>
    </div>
  );
