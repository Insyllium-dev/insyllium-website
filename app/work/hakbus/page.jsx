...
//             src={"/img1_.jpg"}
//             alt="Proejct image"
//             className="w-full h-full object-cover lg:px-20 xl:px-40 2xl:px-[20rem] translate-y-20"
//             width={1000}
//             height={1000}
//           />
//         </div>
...
//         <p className="font-normal text-transparent bg-clip-text bg-gradient-to-br from-neutral-300 from-30% to-cyan-300/40 text-xl md:text-2xl font-poppins">
//           About project
//         </p>
//         <div className="space-y-8">
//           <p className="font-normal text-transparent bg-clip-text bg-gradient-to-br from-neutral-300 from-30% to-cyan-300/40 text-2xl md:text-3xl font-poppins max-w-3xl">
//             Hakbus is an innovative project aimed at revolutionizing
//             transportation.
//           </p>
//           <p className="font-normal text-neutral-300 text-lg font-poppins max-w-3xl">
//             Through meticulous UI/UX design, we&apos;ve created an intuitive
//             platform for Hakbus users. By focusing on user needs and behaviors,
//             we&apos;ve optimized every aspect of the journey, ensuring seamless
//             booking and efficient route suggestions. Our user-centric approach
//             sets a new standard for transportation services.
//           </p>
//         </div>
//       </div>
//       <div className="bg-neutral-500/80 min-h-screen w-full left-1/2 relative -translate-x-1/2">
...
//     <div className="space-y-8">
//         <p className="font-normal text-transparent bg-clip-text bg-gradient-to-br from-neutral-300 from-30% to-cyan-300/40 text-2xl md:text-3xl font-poppins max-w-3xl">
//             Hakbus's mission is to redefine the transportation experience.
//         </p>
//         <p className="font-normal text-neutral-300 text-lg font-poppins max-w-3xl">
