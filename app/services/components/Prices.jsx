...
const Prices = () => {
  return (
    <div className="min-h-screen w-full bg-white relative clipTop2 py-[50px] md:py-[100px]">
      ...
      <div className="flex flex-col justify-between items-start px-4 sm:px-8 md:px-12 lg:px-20 xl:px-40 2xl:px-[20rem] gap-16">
        <div className="flex flex-col gap-6 items-start">
          <h1 className="font-semibold text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl text-black text-start">
            Plans &{" "}
            <span className="font-bold text-transparent bg-clip-text bg-gradient-to-br from-cyan-300/70 to-orange-300/80">
              Pricing
            </span>
          </h1>
          <p className="text-black font-normal text-base sm:text-lg max-w-xl text-start">
        ...
        <div className="w-full h-max rounded-3xl bg-gradient-to-br from-cyan-300/60 to-orange-300/60 p-12 space-y-6 relative">
          ...
          <div className="flex md:justify-start justify-center items-center flex-wrap">
          {pricingPlans?.map((plan, index) => (
            <div key={index} className={`${index==2&&'hidden'} flex flex-col gap-2`}>
          ...
          <div className="flex flex-col gap-4 bg-[#171717] rounded-3xl p-8 absolute right-12 bottom-12">
