    ...
    <>
      ...
      >
        ...
        <MobileAppSection
          title={"Mobile"}
          title2={"Apps"}
          description={`Get ahead in the mobile world with our app development services. We'll help you from start to finish. Count on us to meet your needs and advise you on what's trendy. `}
          subtitle={`Let's turn your ideas into a sleek app that goes wherever you go.`}
          image={"/mobileappbg.png"}
        />
      </div>
      <div
        id="platforms"
